...
function CheckboxField(fieldObject) {
    ...
    defaultValue = "true" == fieldObject.default_value.toLowerCase() ? true : false;
...
function Photo(fieldObject) {
    var textField = Ti.UI.createTextField({
        borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE,
        textAlign: Ti.UI.TEXT_ALIGNMENT_RIGHT,
        value: "This field type is currently not supported",
        editable: false,
        clearButtonMode: Ti.UI.INPUT_BUTTONMODE_ONFOCUS,
        hintText: fieldObject.description,
        width: Ti.UI.FILL,
...
function unknownField(fieldObject) {
    var textField = Ti.UI.createTextField({
        borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE,
        textAlign: Ti.UI.TEXT_ALIGNMENT_RIGHT,
        value: "TalKivi doesn't recognize this field type.",
        editable: false,
        clearButtonMode: Ti.UI.INPUT_BUTTONMODE_ONFOCUS,
        hintText: fieldObject.description,
        width: Ti.UI.FILL,
